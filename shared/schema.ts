...
export const buildopsAgreements = pgTable("buildops_agreements", {
  ...
  buildopsCustomerId: varchar("buildops_customer_id"),
  syncedAt: timestamp("synced_at").defaultNow().notNull(),
  // CSV-imported enrichment fields
  billingCustomerName: varchar("billing_customer_name"),
  departmentName: varchar("department_name"),
  firstBillDate: timestamp("first_bill_date"),
  nextBillDate: timestamp("next_bill_date"),
  billingType: varchar("billing_type"),
  annualContractValue: decimal("annual_contract_value", { precision: 12, scale: 2 }),
  renewalDate: timestamp("renewal_date"),
  soldBy: varchar("sold_by"),
  createdTimestamp: timestamp("created_timestamp"),
  createdBy: varchar("created_by"),
  serviceAgreementType: varchar("service_agreement_type"),
  projectManager: varchar("project_manager"),
  accountManager: varchar("account_manager"),
  totalAmount: decimal("total_amount", { precision: 14, scale: 4 }),
  adjustmentAmount: decimal("adjustment_amount", { precision: 14, scale: 4 }),
  totalCost: decimal("total_cost", { precision: 14, scale: 4 }),
  materialCost: decimal("material_cost", { precision: 14, scale: 4 }),
  labourCost: decimal("labour_cost", { precision: 14, scale: 4 }),
  labourHours: decimal("labour_hours", { precision: 10, scale: 2 }),
  totalBudgetedHours: decimal("total_budgeted_hours", { precision: 10, scale: 2 }),
  totalBudgetedAmount: decimal("total_budgeted_amount", { precision: 14, scale: 4 }),
  numberOfMaintenances: integer("number_of_maintenances"),
  numberOfMaintenancesCompleted: integer("number_of_maintenances_completed"),
  numberOfJobs: integer("number_of_jobs"),
  numberOfJobsCompleted: integer("number_of_jobs_completed"),
  csvImportedAt: timestamp("csv_imported_at"),
});
...
export const opportunities = pgTable("opportunities", {
  ...
  soldById: varchar("sold_by_id").references(() => users.id),
